...
rss_url = "https://www.cazadoresdefakenews.info/categoria/desmentidos/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "venezuela",  # Assuming the organization is based in Venezuela
        "site_name": "cazadoresdefakenews", # Assuming the site name is cablecheck
        "url": entry.link,
