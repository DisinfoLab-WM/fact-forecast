...
rss_url = "https://www.dogrula.org/dogrulamalar/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "turkey",  # Assuming the organization is based in Turkey
        "site_name": "dogrula", # Assuming the site name is dogrula
        "url": entry.link,
        "language": "tr",  # Assuming Turkish for all articles
    }
