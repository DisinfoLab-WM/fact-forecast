...
rss_url = "https://ecuadorchequea.com/category/verificaciones/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "ecuador",  # Assuming the organization is based in Ecuador
        "site_name": "ecuadorchequea", # Assuming the site name is ecuadorchequea
        "url": entry.link,
