...
rss_url = "https://factcheckzw.org/category/featured/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "zimbabwe",  # Assuming the organization is based in Zimbabwe
        "site_name": "factcheckzimbabwe", # Assuming the site name is factcheckzimbabwe
        "url": entry.link,
