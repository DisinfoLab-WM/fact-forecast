...
rss_url = "https://www.fact-watch.org/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "bangladesh",  # Assuming the organization is based in Bangladesh
        "site_name": "factwatch", # Assuming the site name is factwatch
        "url": entry.link,
        "language": "bn",  # Assuming Bangladesh for all articles
    }
