...
rss_url = "https://factcheckcyprus.org/category/fact-checks/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "cyprus",  # Assuming the organization is based in Cyprus
        "site_name": "factcheckcyprus", # Assuming the site name is factcheckcyprus
        "url": entry.link,
