...
rss_url = "https://annielab.org/category/factcheck/feed/"
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "hongkong",  # Assuming the organization is based in Hong Kong
        "site_name": "annielab", # Assuming the site name is annielab
        "url": entry.link,
        "language": "zh",  # Assuming Chinese for all articles
    }
